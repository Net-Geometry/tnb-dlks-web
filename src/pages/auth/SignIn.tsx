        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="max-w-md">
            ...
            <p className="text-lg text-white/90 leading-relaxed">
              Digital Work Management System - Streamlining operations
              with advanced technology and seamless workflows.
            </p>
            <div className="mt-8 flex items-center gap-3">
              <Shield className="w-6 h-6 text-white/80" />
              <span className="text-white/80">Secure • Efficient • Reliable</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 lg:px-8">
        <Card className="w-full max-w-md p-8 shadow-2xl border border-border bg-card/95 backdrop-blur-sm">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-foreground mb-2">User Login</h2>
